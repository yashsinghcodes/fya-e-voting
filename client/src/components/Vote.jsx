...
export const Vote = () => {
  ...
  return (
    <div className='text-white w-1/3 relative m-56 z-[2]'>
        ...
        <button onClick={connectWallet} className='relative top-6 py-3 px-10 hover:shadow-xl bg-white text-[#6C63FF] font-semibold rounded-full'>Connect Your Wallet</button>
    </div>
  )
}
