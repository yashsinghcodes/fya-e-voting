...
export const Card = ({ id }) => {
    ...
    return (
        <>
            <div className='w-64 rounded-md shadow-[0_0_25px_#b6b7ea] flex flex-col items-center p-4 bg-slate-100'>
                ...
                {<button onClick={handleClick} className={`px-12 py-2 text-white ${adminUrlChecker ? "hidden" : ""} text-lg rounded-lg mt-3 hover:bg-[#574fe7] bg-[#6C63FF]`}>Vote</button>}
            </div>
        </>
    )
}
